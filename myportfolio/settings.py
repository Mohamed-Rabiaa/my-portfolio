...
This module contains the Django settings configuration for the MyPortfolio project,
a comprehensive portfolio website with blog functionality and contact management.
The settings are configured for both development and production environments with
proper security, API documentation, and media handling.
...
- Security settings and password validation

Environment Configuration:
- Development: SQLite database, DEBUG=True, local CORS origins
- Production: PostgreSQL database (commented), DEBUG=False, secure settings
